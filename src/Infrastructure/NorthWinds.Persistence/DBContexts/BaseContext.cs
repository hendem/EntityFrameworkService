...
namespace NorthWinds.Persistence.DBContexts
{
    public abstract partial class BaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.CategoryName, "CategoryName_Idx");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.PostalCode, "PostalCode_Idx");

                entity.HasIndex(e => e.Region, "Region_Idx");
            ...
            {
                entity.HasIndex(e => e.LastName, "LastName_Idx");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerId, "CustomersOrders_Idx");

                entity.HasIndex(e => e.EmployeeId, "EmployeeID_Idx");

                entity.HasIndex(e => e.EmployeeId, "EmployeesOrders_Idx");

                entity.HasIndex(e => e.OrderDate, "OrderDate_Idx");

                entity.HasIndex(e => e.ShipPostalCode, "ShipPostalCode_Idx");

                entity.HasIndex(e => e.ShippedDate, "ShippedDate_Idx");

                entity.HasIndex(e => e.ShipVia, "ShippersOrders_Idx");
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.OrderId, "OrdersOrder_Details_Idx");

                entity.HasIndex(e => e.ProductId, "ProductID_Idx");

                entity.HasIndex(e => e.ProductId, "ProductsOrder_Details_Idx");
            ...
            {
                entity.HasIndex(e => e.CategoryId, "CategoriesProducts_Idx");

                entity.HasIndex(e => e.CategoryId, "CategoryID_Idx");

                entity.HasIndex(e => e.ProductName, "ProductName_Idx");

                entity.HasIndex(e => e.SupplierId, "SupplierID_Idx");

                entity.HasIndex(e => e.SupplierId, "SuppliersProducts_Idx");
